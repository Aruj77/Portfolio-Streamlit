...
import base64
import sqlite3
from project_data import projects_data
# Set page title
st.set_page_config(page_title="Aruj Bansal", page_icon = "desktop_computer", layout = "wide", initial_sidebar_state = "auto")
...
footer:after{
    content:'Copyright © 2023 Aruj Bansal';
    position:relative;
    color:black;
}
"""
...
# Assets for about me
img_utown = Image.open("images/my.jpg")
# Assets for competition
image_names=[
    "bvicam",
    "vit",
    "block22",
...
positions = [
    "BVICAM 1st Place",
    "VIT RASVERSE 1st Place",
    "Blockverse'22 1st Place",
    "Blockverse'23 1st Place",
    "Sanrachna 1st Place",
    "HackNITR 1st Energy Track",
    "DUHacks Top 15",
    "Green Energy Computing",
    "Hacktober Fest Contributer",
]

images = [
    Image.open(
        f"competition_images/{name}.{'jpg' if name not in ('map', 'gephi', 'health') else 'png'}"
    )
    for name in image_names
]

# Assets for education
img_akgec = Image.open("images/akgec.jpg")
img_smcsss = Image.open("images/smcsss.jpg")

# Assets for experiences
img_scor = Image.open("images/scor.jpg")
img_feedingtrends = Image.open("images/feedingtrends.jpg")
img_a2creation = Image.open("images/a2creation.jpg")

# Assets for volunteering
image_names_vol = ["gdsclogo", "iitp", "bitsp"]
...
with st.sidebar:
    ...
    github_url = "https://github.com/Aruj77"
    email_url = "mailto:bansalaruj77@gmail.com"
    with st.container():
...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            st.header("About Me")
            st.subheader("Aspiring Data Analyst/Machine Learning Developer")
            st.write("👋🏻 Hi, I'm Aruj! I'm a data science and machine learning enthusiast. Having prior relevant experiences in technology, I am constantly seeking unique internships to broaden my horizons before embarking on my career upon graduation.")
            st.write("💼 With emerging technology, I believe there is potential for machine learning to be applied in the retail industry. In response to the increasing demand for data analytics from both online and brick-and-mortar sales, I am thus aiming to enter this industry for my first full-time job.")
            st.write("🏋🏻 In addition, I like to exercise in the gym, run, write, play video games and... enjoy eating good food in my free time!")
            st.write("👨🏼‍💻 Academic interests: Data Visualization, Recommendation Systems, Natural Language Processing, MERN")
            st.write("💭 Ideal Career Prospects: Data Analyst, Data Scientist, Data Engineer, Machine Learning Developer, Full Stack Developer")
            st.write(
                "📄 [Resume (1 page)](https://drive.google.com/file/d/1_27BA4kALWPq7CC6wJ91-gjA56N49A1u/view?usp=sharing)"
            )
        with middle_column:
            st.empty()
        with right_column:
            st.image(img_utown.rotate(90, expand=True))
elif choose == "Site Overview":   
    # overview.createPage()
    st.header("Site Overview")
    st.markdown("""
    Initally creating this as a portfolio website in the form of an extended resume, I came to discover the uniqueness of Streamlit as compared to typical front-end frameworks such as React and Bootstrap. Even though Streamlit is primarily used as a web application for dashboarding, its extensive features make it more aesthetically appealing to explore with as compared to alternatives such as Plotly and Shiny.
    
    With the convenience of using Python as a beginner-friendly programming language, I have now decided to evolve this personal project into a time capsule - documenting key moments and achievements that I have attained since commencing my formal education. In addition, should I be successful in completing this project, I intend to provide my codes as open-source, so that other students can document their educational journey in a similar manner.
    ...
    *For an optimal experience, do browse this site on desktop!*
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_a2creation)
        with text_column:
            st.subheader("Data Analyst Intern, [A2 Creaction](#)")
            st.write("*Sebtember to November 2022*")
            st.markdown(
                """
            - Executed website scraping and data analysis projects, extracting valuable insights and enhancing decision-making processes.
            - Applied machine learning models to predict company growth accuracy scores, contributing to strategic planning and operational optimization.
            
            `Python` `bs4` `Data Visualization` `Git` `Scikit-Learn` `Matplotlib` `Plotly` `Numpy` `Pandas`
            """
            )
    with st.container():
        image_column, text_column = st.columns((1,5))
        with image_column:
            st.image(img_feedingtrends)
        with text_column:
            st.subheader(
                "Machine Learning Intern, [Feeding Trends](https://feedingtrends.com/)"
            )
            st.write("*April to Sebtember 2022*")
            st.markdown("""
            - Completed internship with positive feedback, demonstrating strong performance in task execution and team contribution.
            - Gained foundational knowledge in machine learning principles and techniques.
            - Commended for enthusiasm and dedication to mastering machine learning concepts, showcasing a proactive approach to professional development.

            `Python` `BeautifulSoup4` `SciKit Learn` `Streamlit` `Pandas` `Plotly` `Sweety` `PowerBI`
            """)
    with st.container():
        image_column, text_column = st.columns((1,5))
        with image_column:
        ...
        with text_column:
            ...
            st.write("*May to August 2021* | [*Testimonial*](https://drive.google.com/file/d/1rr2c5yQEKAYd_rSl8GNh2jUOSbaCwIhO/view?usp=sharing)")
            st.markdown("""
    ...
    txt3("Programming Languages","`C++`, `Python`, `SQL`, `JavaScript`")
    txt3("Academic Interests","`Data Visualization`, `Market Basket Analysis`, `Recommendation Systems`, `Natural Language Processing`")
    txt3("Data Visualization", "`ggplot2`, `matplotlib`, `seaborn`, `Plotly`, `Librosa`, `GIS`, `Tableau`, `Power BI`, `Google Data Studio`, `Google Analytics`")
    txt3("Database Systems", "`MySQL`, `MongoDB`, `SQLite`, `NoSQL`")
    txt3("Cloud Platforms", "`Google Cloud Platform`, `Amazon Web Services`, `Heroku`, `Streamlit Cloud`, `Render`, `Hugging Face`, `Vercel`, `Railway`")
    txt3("Natural Language Processing", "`NLTK`, `Word2Vec`, `TF-IDF`, `TextStat`")
    txt3("Version Control", "`Git`, `Docker`")
    txt3("Web Development", "`MongoDB`, `Express`, `React`, `Node.js`, `Django`")
    ...
    txt3("Machine Learning Frameworks", "`Numpy`, `Pandas`, `Scikit-Learn`, `TensorFlow`, `Keras`, `Computer Vision`, `bs4`, `Selenium`")
    txt3("Task Management Tools", "`Notion`, `Jira`, `Confluence`")
    txt3("Miscellaneous", "`Google Firebase`, `Microsoft Office`, `Retool`, `Google Ads`, `Photoshop`, `Premiere Pro`")
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_akgec, width=250)
        with text_column:
            st.subheader("Bachelor of Technology - [Computer Science, Ajay Kumar Garg Engineering College](https://akgec.ac.in) (2021-2025)")
            st.write("I completed a demanding course of study at AKGEC College to earn a BTech in computer science. The course included important topics that are fundamental to the field. Basic subjects including Database Technology and Management, Data Structures and Algorithms, and Programming Tools for Economics were covered in my education. In order to better prepare myself for the world of data analysis and computational techniques, I also studied advanced topics such as Convex Optimization, Regression Analysis, and Statistical Learning. In addition, I improved my knowledge of probability, multivariable calculus, and linear algebra—all of which are essential for solving challenging computational issues and statistical modeling. I have consistently shown a strong commitment to fusing theoretical understanding with real-world applications throughout my academic career, setting myself up for a successful career in computer science.")
    with st.container():
        image_column, text_column = st.columns((1,2.5))
        with image_column:
            st.image(img_smcsss, width=250)
        with text_column:
            st.subheader(
                "12th Standard - Pharmaceutical Science, [St. Mary's Convent Sr. Sec. School](https://www.stmarysdhampur.in/) (2020-2021)"
            )
            st.write(
                "During my 12th grade at St. Mary's Convent Sr. Sec. School, I achieved a commendable percentage of 95.2%. This period was instrumental in laying a strong foundation for my academic journey. I engaged deeply with subjects such as Mathematics, Physics, Chemistry, and Computer Science, fostering a keen interest in problem-solving and analytical thinking. The rigorous curriculum and supportive environment at St. Mary's Convent Sr. Sec. School provided me with invaluable skills in critical analysis, time management, and academic excellence. My dedication to learning and achieving high academic standards during this time has been integral to shaping my academic pursuits and career aspirations."
            )
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_smcsss, width=250)
        with text_column:
            st.subheader("10th Standard - [St. Mary's Convent Sr. Sec. School](https://www.stmarysdhampur.in/) (2019-2020)")
            st.write("During my 10th grade at St. Mary's Convent Sr. Sec. School, I achieved an impressive percentage of 94.7%. This phase marked a pivotal period in my academic journey, where I laid a solid foundation in fundamental subjects such as Mathematics, Science, Social Studies, and English. The supportive learning environment and comprehensive curriculum at St. Mary's Convent Sr. Sec. School played a crucial role in enhancing my academic skills, critical thinking abilities, and time management. My consistent dedication to academic excellence during this period has significantly contributed to shaping my educational goals and aspirations for the future.")
elif choose == "Competitions":
    st.header("Competitions")

    n_rows = 1 + len(images) // 4
    rows = [st.container() for _ in range(n_rows)]
    cols_per_row = [r.columns(4) for r in rows]

    for image_index, (img, name, position) in enumerate(
        zip(images, image_names, positions)
    ):
        row_index = image_index // 4
        col_index = image_index % 4
        with cols_per_row[row_index][col_index]:
            st.image(img, caption=f"{position}", width=250)
    ...
    def display_project(project):
        ...
        if "live_demo_link" in project:
            st.write(
                f"[Live Demo]({project['live_demo_link']}) | [GitHub Repo]({project['github_link']})"
            )
        else:
            st.write(f"[GitHub Repo]({project['github_link']})")

    # Collect all unique technologies from projects_data
    all_technologies = sorted(
        set(tech for project in projects_data for tech in project["technologies"])
    )

    # Allow user to select multiple technologies
    choose = st.multiselect("Select technologies", all_technologies, default=[])

    if not choose:  # If no technologies selected, show all projects
        st.header(f"Projects ({len(projects_data)})")
        for project in projects_data:
            with st.container():
                ...
                with image_column:
                    if project['title'] == "PixelCops: Image Authentication and Origin Tracing":
                        st.image(project['image'], width=180)
                    else:
                        st.image(project['image'], width=350)

    else:  # Filter projects based on selected technologies
        filtered_projects = [
            project
            for project in projects_data
            if set(choose).issubset(set(project["technologies"]))
        ]
        st.header(f"Projects ({len(filtered_projects)})")
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Google Developer Student Clubs IITD")
            st.write("*September 2021 to April 2022*")
            st.markdown("""
            Co-ordinater of Development Domain

            - Managed technical requirements of student club alongside Core Team to ensure fluent flow for technical workshops, hackathon and external projects
            - Liaised with staff advisors and administrative staff to seek tech approvals and process tech claims for other student members
            """)
        with mid:
            st.empty()
        with image_column:
    ...
    with st.container():
        text_column, mid, image_column = st.columns((3,0.4,1))
        with text_column:
            st.subheader("Campus Ambassador at IIT Patna")
            st.write("*Feburary 2023 to July 2023*")
            st.markdown(
                """
            - I actively promoted the brand on campus by organizing events, distributing promotional materials, and leveraging social media to enhance engagement among students.
            - I also served as a liaison, gathering feedback from peers and building relationships with students, faculty, and campus organizations to strengthen the brand's presence and foster collaboration.
            """
            )
        with mid:
            st.empty()
    ...
    with st.container():
        text_column, mid, image_column = st.columns((3, 0.4, 1))
        with text_column:
            st.subheader("Campus Ambassador at Bits Pilani")
            st.write("*September 2022 to December 2022*")
            st.markdown(
                """
            - I actively promoted the brand on campus by organizing events, distributing promotional materials, and leveraging social media to enhance engagement among students.
            - I also served as a liaison, gathering feedback from peers and building relationships with students, faculty, and campus organizations to strengthen the brand's presence and foster collaboration.
    ...
    if selected == "Overview":
        ...
        **Learnings**
        ...
        3. Failure is the key to success (by Aruj)
        ...
        *Aruj Bansal is the Marketing Director of the NUS Statistics and Data Science Society (AY21/22)*       
        """)
    ...
    resume_url = "https://drive.google.com/file/d/1_27BA4kALWPq7CC6wJ91-gjA56N49A1u/view?usp=sharing"
    st.header("Resume")
    ...
    show_pdf("Aruj Resume.pdf")
    with open("Aruj Resume.pdf", "rb") as file:
        btn = st.download_button(
            label="Download Resume (1 page)",
            data=file,
            file_name="Aruj Resume.pdf",
    ...
    with st.container():
        ...
        st.write("Let's connect! You may either reach out to me at bansalaruj77@gmail.com or use the form below!")
...
st.markdown("*Copyright © 2024 Aruj Bansal*")
